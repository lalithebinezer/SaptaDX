  ...
  return (
    <div className="flex-1 max-w-6xl mx-auto px-6 py-20">
      ...
      >
        ...
        <p className="text-xl text-muted-foreground">The visionaries behind Sapta's digital excellence.</p>
      </motion.div>
        ...
        {team.map((member, i) => (
          ...
          >
            <div className="w-full md:w-1/3">
              <div className="aspect-[4/5] glass rounded-[40px] relative overflow-hidden group border border-glass-border">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              <div>
                <h2 className="text-4xl font-bold mb-1">{member.name}</h2>
