...
export function SunIcon({ size = 48, className }: WeatherIconProps) {
  return (
    <motion.svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size } as any}>
      <motion.g animate={{ rotate: 360 }} transition={{ duration: 12, ease: "linear", repeat: Infinity }}>
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
          <motion.line key={deg} x1="24" y1="6" x2="24" y2="10" stroke="currentColor" strokeWidth={2} strokeLinecap="round"
            style={{ transformOrigin: "24px 24px", rotate: deg } as any}
            animate={{ opacity: [0.4, 1, 0.4] }}
            transition={{ duration: 2, repeat: Infinity, delay: deg / 360 }} />
        ))}
      </motion.g>
      <motion.circle cx="24" cy="24" r="8" fill="currentColor" opacity={0.1}
...
export function MoonIcon({ size = 48, className }: WeatherIconProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <path d="M28 8a14 14 0 100 28 10 10 0 01 0-28z" fill="currentColor" opacity={0.1} />
      <path d="M28 8a14 14 0 100 28 10 10 0 01 0-28z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      {stars.map((s) => (
        <motion.circle key={s.cx + s.cy} cx={s.cx} cy={s.cy} r="1" fill="currentColor"
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g animate={{ x: [0, 2, 0, -2, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}>
        <path d="M36 30H14a8 8 0 01-.5-16A10 10 0 0134 16a7 7 0 012 14z" fill="currentColor" opacity={0.1} />
        <path d="M36 30H14a8 8 0 01-.5-16A10 10 0 0134 16a7 7 0 012 14z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      </motion.g>
    </svg>
  );
}
...
export function RainIcon({ size = 48, className }: WeatherIconProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <path d="M36 22H14a7 7 0 01-.5-14A9 9 0 0134 10a6 6 0 012 12z" fill="currentColor" opacity={0.1} />
      <path d="M36 22H14a7 7 0 01-.5-14A9 9 0 0134 10a6 6 0 012 12z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      {drops.map((drop) => (
        <motion.line key={drop.x} x1={drop.x} y1={26} x2={drop.x} y2={30} stroke="currentColor" strokeWidth={2} strokeLinecap="round"
...
export function HeavyRainIcon({ size = 48, className }: WeatherIconProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <path d="M36 20H14a7 7 0 01-.5-14A9 9 0 0134 8a6 6 0 012 12z" fill="currentColor" opacity={0.1} />
...
export function SnowIcon({ size = 48, className }: WeatherIconProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      ...
      <path d="M36 22H14a7 7 0 01-.5-14A9 9 0 0134 10a6 6 0 012 12z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      {flakes.map((f, i) => (
        <motion.circle key={i} cx={f.x} cy={26} r={1.5} fill="currentColor"
...
export function ThunderIcon({ size = 48, className }: WeatherIconProps) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <path d="M36 20H14a7 7 0 01-.5-14A9 9 0 0134 8a6 6 0 012 12z" fill="currentColor" opacity={0.05} />
      <path d="M36 20H14a7 7 0 01-.5-14A9 9 0 0134 8a6 6 0 012 12z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      <motion.path d="M26 20l-3 8h6l-3 10" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round"
        animate={{ opacity: [0, 1, 1, 0, 0, 0, 1, 0, 0, 0] }}
        transition={{ duration: 3, repeat: Infinity }} />
      <motion.path d="M26 20l-3 8h6l-3 10" fill="currentColor" opacity={0}
...
export function WindIcon({ size = 48, className }: WeatherIconProps) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.path d="M6 18h26a4 4 0 000-8" stroke="currentColor" strokeWidth={2} strokeLinecap="round"
        animate={{ pathLength: [0, 1] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }} />
      <motion.path d="M6 24h32a3 3 0 010 6" stroke="currentColor" strokeWidth={2} strokeLinecap="round"
        animate={{ pathLength: [0, 1] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut", delay: 0.3 }} />
      <motion.path d="M10 30h18a3 3 0 000-0" stroke="currentColor" strokeWidth={2} strokeLinecap="round" opacity={0.5}
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g animate={{ rotate: 360 }} transition={{ duration: 20, ease: "linear", repeat: Infinity }}
        style={{ transformOrigin: "16px 16px" } as any}>
        {[0, 60, 120, 180, 240, 300].map((deg) => (
          <line key={deg} x1="16" y1="6" x2="16" y2="9" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round"
            style={{ transformOrigin: "16px 16px", rotate: deg } as any} />
        ))}
      </motion.g>
      <circle cx="16" cy="16" r="6" stroke="currentColor" strokeWidth={1.5} fill="currentColor" fillOpacity={0.1} />
      <motion.g animate={{ x: [0, 1.5, 0, -1.5, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}>
        <path d="M38 34H18a7 7 0 01-.5-14A9 9 0 0136 22a6 6 0 012 12z" fill="currentColor" opacity={0.1} />
        <path d="M38 34H18a7 7 0 01-.5-14A9 9 0 0136 22a6 6 0 012 12z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      </motion.g>
    </svg>
  );
}
...
export function SunriseIcon({ size = 48, className }: WeatherIconProps) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <line x1="6" y1="34" x2="42" y2="34" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
      <motion.g animate={{ y: [4, 0] }} transition={{ duration: 3, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" }}>
        <path d="M12 34a12 12 0 0124 0" fill="currentColor" opacity={0.1} />
        <path d="M12 34a12 12 0 0124 0" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
        {[0, 30, 60, 90, 120, 150, 180].map((deg) => (
          <line key={deg} x1="24" y1="14" x2="24" y2="17" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round"
            style={{ transformOrigin: "24px 34px", rotate: deg - 90 } as any} />
        ))}
      </motion.g>
      <motion.path d="M24 42V36" stroke="currentColor" strokeWidth={2} strokeLinecap="round"
        animate={{ y: [2, -2, 2] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
      <motion.path d="M20 38l4-4 4 4" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"
        animate={{ y: [2, -2, 2] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
    </svg>
  );
}
